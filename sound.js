...
let sound = new Sound(document.querySelector("#sound-div")),
    backgroundSound =  sound.create("sounds/Tetris_bgm.mp3", "background_sound", true),
    //movesSound = sound.create("sounds/moves.mp3", "moves_sound"),
    //dropSound = sound.create("sounds/drop.mp3", "drop_sound"),
    //pointsSound = sound.create("sounds/points.mp3", "points_sound"),
    finishSound = sound.create("sounds/game_over.mp3", "finish_sound");;
sound.muteToggle();
sound.soundSetting();
